...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    void _submit() {
      LoginStatus loginStatus = context.read<LoginCubit>().state.status;
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage("assets/images/flutter_big_logo.png"),
                      ),
                    ),
                  ),
                  SizedBox(
                              ...
                              Opacity(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    disabledBackgroundColor: Color(0xffB9C3FF),
